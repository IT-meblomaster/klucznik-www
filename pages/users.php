...
if (!has_permission($pdo, 'pages.uzytkownicy.view') && !has_permission($pdo, 'pages.uzytkownicy.edit')) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!has_permission($pdo, 'pages.uzytkownicy.edit')) {
        http_response_code(403);
        require __DIR__ . '/forbidden.php';
        return;
    }
...
<style>
    ...
    .users-actions-wrap .btn,
    .users-actions-wrap form,
    .users-actions-wrap form .btn {
        width: 100%;
    }
</style>
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle users-table">
                    <colgroup>
                        <col class="users-login-col">
                        <col class="users-name-col">
                        <col class="users-email-col">
                        <col class="users-status-col">
                        <col class="users-login-at-col">
                        <col class="users-actions-col">
                    </colgroup>
                    <thead>
                    <tr>
                        <th>Login</th>
                    ...
                    <?php foreach ($users as $row): ?>
                        ...
                        <tr class="users-main-row">
                            ...
                            <td class="users-actions-cell">
                                <?php if (has_permission($pdo, 'pages.uzytkownicy.edit')): ?>
